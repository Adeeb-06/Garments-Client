                ...
                <tbody className="divide-y divide-base-300">
                  {filteredProducts?.length > 0 ? (
                    filteredProducts.map((product, index) => (
                      <tr
                        key={index}
                        className="hover:bg-primary/70 transition-colors"
                      >
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`inline-flex px-3 py-1 text-sm font-semibold rounded-full text-gray-700 `}
                          >
                            {product.createdBy || "NA"}
                          </span>
                        </td>
                        <td className="px-6 py-4 text-center">
                          <button
                            onClick={() =>
                              toggleShowOnHome(product._id, product.onHomePage)
                            }
                            className={`px-4 py-2 text-sm rounded-lg font-semibold transition-all shadow 
        ${
          product.onHomePage
