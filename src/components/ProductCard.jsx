  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-base-300 hover:shadow-xl transition-all duration-300 group">
      ...
      <div className="p-6">
        ...
        {/* View Details Button */}
        <Link to={`/product/${product._id}`} className="w-full cursor-pointer bg-primary text-secondary py-3 rounded-lg font-semibold hover:opacity-90 transition-all flex items-center justify-center space-x-2 shadow-md">
