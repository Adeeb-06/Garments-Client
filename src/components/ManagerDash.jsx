      ...
      <div className=" mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Link to="/dashboard/users" className="flex flex-col items-center justify-center p-6 border-2 border-gray-200 rounded-xl hover:border-secondary hover:bg-secondary/5 transition-all group">
              <div className="bg-secondary/10 p-4 rounded-full mb-3 group-hover:bg-secondary/20 transition-all">
