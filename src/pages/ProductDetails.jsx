...
import { ShoppingCart, Package, CreditCard, DollarSign, Tag, Minus, Plus, ArrowLeft } from 'lucide-react';
...
export default function ProductDetailsPage() {
  ...
  if(isLoading) return <div className='flex justify-center items-center  w-full h-screen'><span className="loading mx-auto  w-10 h-10 loading-spinner text-secondary"></span></div>;
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-base-300">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                  ...
                  <p className="text-2xl font-bold text-yellow-600">{product?.min_order} pcs</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-base-300">
              ...
              <div className="grid grid-cols-2 gap-3">
                  ...
                  <div
                    className="flex items-center space-x-2 bg-primary px-4 py-3 rounded-lg border border-base-300"
                  >
                    <DollarSign className="w-4 h-4 text-primary" />
                    <span className="text-md font-medium text-gray-700">{product?.payment}</span>
                  </div>
            ...
            {/* Order Button */}
            <Link to={`/order/${product?._id}`} className="w-full bg-secondary text-primary py-4 rounded-xl font-bold text-lg hover:opacity-90 transition-all shadow-lg flex items-center justify-center space-x-3">
