          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="block w-full pl-10 pr-3 py-3 border border-base-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all outline-none appearance-none bg-white"
                  >
              ...
              <button
                ...
                className="w-full bg-white border-2 border-base-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-base-200 transition-all flex items-center justify-center space-x-3 shadow-sm hover:shadow-md"
              >
